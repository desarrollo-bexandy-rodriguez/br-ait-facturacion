...
$this->data .= "</div></td><td id='co-right'><div id='bigi'>FACTURA</div><div id='invinfo'>";
...
// BILL TO
$this->data .= "<table id='billship'><tr><td><strong>CLIENTE</strong><br>";
foreach ($this->billto as $b) { $this->data .= $b."<br>"; }

// SHIP TO
$this->data .= "</td><td><strong>MÉTODO DE PAGO</strong><br>";
foreach ($this->shipto as $s) { $this->data .= $s."<br>"; }
$this->data .= "</td></tr></table>";

// ITEMS
$this->data .= "<table id='items'><tr><th>Item</th><th>Cantidad</th><th>Precio Unitario</th><th>Monto</th></tr>";
